"""Stage 4: Export pipeline data into dashboard-ready files.
...
def run(researchers: list[dict] | None = None) -> None:
    """Export pipeline data into dashboard-ready files.

    Args:
        researchers: Researcher list. If None, loads from Stage 3 output.
    """
    if researchers is None:
        # Try loading from the latest available stage output
